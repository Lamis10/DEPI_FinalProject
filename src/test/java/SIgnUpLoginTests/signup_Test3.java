...
//Verify that the system does not allow signing up with an already registered email.
public class signup_Test3 {
        WebDriver driver;
        HomePage Homepage;
        signup_page Signup;
      ...
      @BeforeClass	
        ...
        public void verify_Enteraccounts() {
            ...
            Signup.write_NAME("hanaayman");
            Signup.write_passward("nana@1234");
