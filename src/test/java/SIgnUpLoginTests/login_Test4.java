...
public class login_Test4 {
   // Verify that the system does not allow logging in with non registered email
   WebDriver driver;
    HomePage Homepage;
    loginpage Login;
  ...
  @BeforeClass	
    ...
    public void verify_Enteraccounts() {
        ...
        Login.write_NAME("hanaaymanmohamed");
        Login.write_passward("hanona3033");
        Login.click_login();
    }
    @AfterClass
